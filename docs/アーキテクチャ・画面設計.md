...
├─ ConfirmDialog.svelte  … 確認ダイアログ（終了時の未保存確認・インポート上書き確認 等）
...
│  │  ├─ App.svelte
│  │  ├─ lib/
│  │  │  ├─ components/          # TabBar / OpenFilesList / Toolbar / Preview / Editor / SettingsPanel / ColorField / ConfirmDialog / ExportPickerDialog / RiskyConfirmDialog / ContextMenu
